    ...
    <div className="space-y-6">
      ...
      <div className="card p-6 shadow-2xl">
        <div className="relative group">
          <div className="absolute inset-y-0 left-0 pl-6 flex items-center pointer-events-none group-focus-within:text-purple-600 transition-colors">
          ...
          <input
            ...
            className="search-input pl-14 pr-6 text-base"
          />
          {searchTerm && (
            <button
              onClick={() => setSearchTerm("")}
              className="absolute inset-y-0 right-0 pr-6 flex items-center hover:scale-110 transition-transform"
            >
      ...
      <div className="card p-8 shadow-2xl">
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center space-x-3">
            ...
            {hasActiveFilters && (
              <span className="ml-auto px-4 py-1.5 bg-gradient-to-r from-purple-100 to-blue-100 text-purple-800 rounded-full text-sm font-bold shadow-md">
                ✓{" "}
                {
          ...
          <div className="flex items-center space-x-3">
            <button
              ...
              className="flex items-center space-x-2 px-4 py-2.5 bg-gradient-to-r from-gray-50 to-gray-100 hover:from-gray-100 hover:to-gray-200 rounded-xl transition-all duration-300 border border-gray-200 font-semibold text-gray-700 shadow-md hover:shadow-lg"
            >
              <AdjustmentsHorizontalIcon className="h-5 w-5" />
              <span>{showAdvancedFilters ? "← Basic" : "Advanced →"}</span>
            </button>
            {hasActiveFilters && (
              <button
                onClick={clearAllFilters}
                className="flex items-center space-x-2 px-4 py-2.5 bg-gradient-to-r from-red-100 to-red-200 hover:from-red-200 hover:to-red-300 text-red-700 rounded-xl transition-all duration-300 font-semibold shadow-md hover:shadow-lg"
              >
        ...
        <div className="mb-6">
          ...
          <div className="flex flex-wrap gap-2">
            {filterOptions.cuisines
              ?.slice(0, showAdvancedFilters ? undefined : 8)
              .map((cuisine) => (
                <button
                  key={cuisine}
